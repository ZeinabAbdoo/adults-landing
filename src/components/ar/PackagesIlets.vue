        ...
        <div class="package-card">
          ...
          <div class="card-body">
            ...
            <h2>{{ prices[31]?.price }}
              ...
              <span class="sloped-line">{{ prices[31]?.beforePrice }}</span> 
            </h2>
            ...
            <button @click="addToCart(prices[31]?.packageId)">شراء</button>
          </div>
        </div>
        <div class="package-card">
          <div class="card-header">
      ...
      <div class="packages-cards" v-else-if="selectedMenu === 'four-months'">
        ...
        <div class="package-card">
          ...
          <div class="card-body">
            ...
            <h2>
              {{ prices[33]?.price }}
                            <span class="sloped-line">{{ prices[33]?.beforePrice }}</span> 
        ...
        <div class="package-card">
          ...
          <div class="card-body">
            <p>الحد الأدنى من الدعم مع جلستين أسبوعيًا وجلسة نادي واحدة وتقييم شهري.</p>
            <h2>{{ prices[32]?.price }}
                            <span class="sloped-line">{{ prices[32]?.beforePrice }}</span> 
            ...
            <button @click="addToCart(prices[32]?.packageId)">شراء</button>
          </div>
        </div>
      </div>
      ...
      <div class="packages-cards" v-else-if="selectedMenu === 'six-months'">
        ...
        <div class="package-card">
          ...
          <div class="card-body">
            <p>الحد الأدنى من الدعم مع جلستين أسبوعيًا وجلسة نادي واحدة وتقييم شهري.</p>
            <h2>{{ prices[34]?.price }}
                                          <span class="sloped-line">{{ prices[34]?.beforePrice }}</span> 
            ...
            <button @click="addToCart(prices[34]?.packageId)">شراء</button>
          </div>
        </div>
      </div>
    </div>
